...
import AccountNav from "./Navbar/MyAccount/Acccount-Nav";
import AccountNavMobile from "./Navbar/MyAccount/Account-Nav-Mobile";
...
const AccountLayout: React.FC<AccountLayoutProps> = ({ children }) => {
  return (
    <div className="border-t border-b border-border-one">
      <Container>
        <div className="pt-10 2xl:pt-12 pb-12 lg:pb-14 xl:pb-16 2xl:pb-20 xl:max-w-screen-xl 2xl:max-w-[1300px] mx-auto">
          <div className="flex flex-col w-full lg:flex-row">
            ...
            <div className="w-full p-4 mt-4 border rounded-md lg:mt-0 border-border-one sm:p-5 lg:py-8 2xl:py-10 lg:px-7 2xl:px-12">
              {children}
            </div>
          </div>
        </div>
