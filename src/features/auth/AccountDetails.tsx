...
import { UpdateUserType } from "@query/types";
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <form
        ...
        noValidate
      >
        <div className="border-b border-border-one pb-7 md:pb-8 lg:pb-10">
        ...
        <div className="border-b border-border-one pb-7 md:pb-9 lg:pb-10">
          <div className="flex flex-col space-y-4 sm:space-y-5">
            <div className="flex flex-col sm:flex-row -mx-1.5 md:-mx-2.5 space-y-4 sm:space-y-0">
              <Input
                type="email"
